  ...
  return (
    <Screen>
      <Animated.View entering={FadeInDown.duration(400)}>
        <Text style={[typeScale.label, { color: colors.gold }]}>TOWER OF SOL</Text>
        <Text style={[typeScale.display, { color: colors.ink, marginTop: 4 }]}>
          Ascend the Tower
        </Text>
        <Text style={[typeScale.body, { color: colors.dim, marginTop: 6 }]}>
      ...
      <Card accent={current.accent}>
        ...
        <Text style={[typeScale.h1, { color: colors.ink }]}>{current.name}</Text>
        <Text style={[typeScale.body, { color: colors.dim }]}>{current.tagline}</Text>
      ...
      <Text style={[typeScale.h2, { color: colors.ink }]}>How ascension works</Text>
      {[
        ...
        <Card key={t}>
          <Text style={[typeScale.body, { color: colors.ink, fontWeight: '700' }]}>{t}</Text>
          <Text style={[typeScale.caption, { color: colors.dim }]}>{d}</Text>
        </Card>
      ))}
